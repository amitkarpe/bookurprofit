...
# if len(sys.argv) != 2:
#     print("Usage: python CheckApproval.py <blockchain> <investment token> <buy token> <buying amount with decimal>")
...
print("CheckApproval was successful ✅ for", token, "with amount", amount)
# print("\n\n")
